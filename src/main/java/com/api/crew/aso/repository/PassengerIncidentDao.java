...
@Repository
public interface PassengerIncidentDao extends CrudRepository<PassengerIncidentDto, Integer> {
	
	public PassengerIncidentDto findByPassengerId(Long passengerId);
	
	public List<PassengerIncidentDto> findTop10ByIncidentStatusOrderByCreationDateDesc(String incidentStatus);
